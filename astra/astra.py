...
def run_astra_with_generator(settings=None, astra_input_file=None, generator_input_file=None, wordir=None, astra_bin=None, generator_bin=None, timeout=2500, verbose=False):
    """
    ...
    A = Astra(astra_bin=astra_bin, input_file=astra_input_file, workdir=wordir)
    A.timeout=timeout
    A.verbose = verbose
